...
public class MyFileRecordReader2 implements RecordReader<LongWritable, Text> {
  private static final Log LOG
    = LogFactory.getLog(MyFileRecordReader2.class.getName());
  ...
  public MyFileRecordReader2(Configuration job, 
                          FileSplit split) throws IOException {
    this(job, split, null);
  }

  public MyFileRecordReader2(Configuration job, FileSplit split,
  ...
  public MyFileRecordReader2(InputStream in, long offset, long endOffset,
                          int maxLineLength) {
